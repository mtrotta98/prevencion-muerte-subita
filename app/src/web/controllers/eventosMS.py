...
def eventos_sede(sede_id):
    ...
    return render_template("eventosMS/lista_eventos_sede.html", eventos=eventos_list, sede=sede)
...
def eventos_provincia(provincia_id):
    ...
    return render_template("eventosMS/lista_eventos_provincia.html", eventos=eventos_list, provincia=provincia)
...
def evento_new(sede_id):
    ...
    return render_template("eventosMS/new.html",form=newEvento, sede_id=sede_id)
...
def evento_detail(id):
    ...
    return render_template("eventosMS/detail.html",form=eventoForm)
